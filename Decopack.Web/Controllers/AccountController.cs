    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (usuarioP.Listar().Count == 0)
            {
                ...
                usuario.Password = "123456789Decopack.";
                usuario.ConfirmPassword = "123456789Decopack";

                var user1 = new ApplicationUser { UserName = usuario.Email, Email = usuario.Email };
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (usuarioP.Listar().Count == 0)
                {
                    ...
                    {
                        if (item.UserName == "admin@hotmail.com")
                        {
